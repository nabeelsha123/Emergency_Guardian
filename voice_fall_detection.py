# emergency_voice_detector_multilingual.py
...
print("=" * 70)
print("🎤 MULTILINGUAL EMERGENCY VOICE DETECTOR")
print("=" * 70)
print("Supports: English + Malayalam + Custom Keywords")
print("=" * 70)
...
class MultilingualEmergencyDetector:
    def __init__(self):
        ...
        print("✅ Initializing multilingual detector...")
    ...
    def handle_emergency(self, text, keywords, languages, level='medium'):
        ...
        if 'malayalam' in languages:
            print("   മലയാളം: 'സഹായം വരുന്നു! ശാന്തമായിരിക്കൂ.'")
        if 'hindi' in languages:
            print("   हिंदी: 'मदद आ रही है! शांत रहें.'")
        if 'english' in languages or not languages:
            print("   English: 'HELP IS COMING! STAY CALM.'")
    ...
    def start(self):
        """Start the detector"""
        print("\n" + "=" * 70)
        print("🚀 STARTING MULTILINGUAL EMERGENCY DETECTOR")
        print("=" * 70)
...
if __name__ == "__main__":
    print("Multilingual Emergency Voice Detector")
    print("Version: 3.0 - English + Malayalam + Hindi + Custom")
    print("=" * 70)
    ...
    print("\n👋 Thank you for using Multilingual Emergency Detector!")